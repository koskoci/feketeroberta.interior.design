		...
		case 'Enteriors':
			if (route.a.$ === 'Nothing') {
				...
				return A4(
					...
					$author$project$Main$ViewImage($author$project$Main$Enterior),
					index);
			}
		case 'Moodboards':
			if (route.a.$ === 'Nothing') {
				...
				return A4(
					...
					$elm$core$Array$fromList($author$project$Images$latvanytervek),
					$author$project$Main$height,
					$author$project$Main$ViewImage($author$project$Main$Moodboard),
					index);
			}
		case 'About':
