...
var $author$project$Main$Enteriors = function (a) {
	return {$: 'Enteriors', a: a};
};
var $author$project$Main$Moodboards = function (a) {
	return {$: 'Moodboards', a: a};
};
...
var $author$project$Main$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$Enteriors($elm$core$Maybe$Nothing),
			$elm$url$Url$Parser$s('enterior')),
			A2(
			$elm$url$Url$Parser$map,
			A2($elm$core$Basics$composeL, $author$project$Main$Enteriors, $elm$core$Maybe$Just),
			A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Moodboards($elm$core$Maybe$Nothing),
			$elm$url$Url$Parser$s('latvanyterv')),
			A2(
			$elm$url$Url$Parser$map,
			A2($elm$core$Basics$composeL, $author$project$Main$Moodboards, $elm$core$Maybe$Just),
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('latvanyterv'),
				$elm$url$Url$Parser$int)),
			...
			$elm$url$Url$Parser$s('rolam')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$Contact,
			$elm$url$Url$Parser$s('elerhetoseg'))
		]));
var $author$project$Main$parse = function (url) {
	return A2(
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			{
				key: key,
				route: $author$project$Main$parse(url)
			},
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$toPath = F2(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'EnteriorsClicked':
				return _Utils_Tuple2(
					model,
					A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/enterior'));
			case 'MoodboardsClicked':
				return _Utils_Tuple2(
					model,
					A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/latvanyterv'));
			case 'AboutClicked':
				return _Utils_Tuple2(
					model,
					A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/rolam'));
			case 'ContactClicked':
				return _Utils_Tuple2(
					model,
					A2($elm$browser$Browser$Navigation$pushUrl, model.key, '/elerhetoseg'));
			case 'EnteriorsImageClicked':
				var index = msg.a;
				var path = $elm$core$String$concat(
					_List_fromArray(
						[
							'/enterior/',
							$elm$core$String$fromInt(index)
			...
			default:
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$browser$Browser$Navigation$pushUrl,
						model.key,
						A2($author$project$Main$toPath, album, index)));
		}
	});
...
var $author$project$Main$Enterior = {$: 'Enterior'};
var $author$project$Main$ImageRequested = F2(
	function (a, b) {
		return {$: 'ImageRequested', a: a, b: b};
	});
var $author$project$Main$Moodboard = {$: 'Moodboard'};
...
var $author$project$Main$about = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$src('/assets/portre2.jpg'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
...
var $author$project$ImageViewer$enlargedImage = F2(
	function (height, url) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$height(height),
...
var $author$project$ImageViewer$view = F5(
	function (height, viewMsg, prevIndex, nextIndex, url) {
		var rightArrow = A2(
			$rtfeldman$elm_css$Html$Styled$img,
			_List_fromArray(
				[
					...
					viewMsg(nextIndex)),
					$rtfeldman$elm_css$Html$Styled$Attributes$src('/assets/navigate_next.svg')
				]),
			_List_Nil);
		var leftArrow = A2(
			$rtfeldman$elm_css$Html$Styled$img,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					viewMsg(prevIndex)),
					$rtfeldman$elm_css$Html$Styled$Attributes$src('/assets/navigate_before.svg')
				]),
			_List_Nil);
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			...
			_List_fromArray(
				[
					leftArrow,
					A2($author$project$ImageViewer$enlargedImage, height, url),
					rightArrow
				]));
	});
var $author$project$ImageViewer$call = F4(
	function (images, height, viewMsg, index) {
		var url = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Array$get, index, images));
		var prevIndex = A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(images),
			index - 1);
		var nextIndex = A2(
			$elm$core$Basics$modBy,
			$elm$core$Array$length(images),
			index + 1);
		return A5($author$project$ImageViewer$view, height, viewMsg, prevIndex, nextIndex, url);
	});
...
var $author$project$Main$standardWidth = 980;
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$Attributes$src('/assets/portre1.jpg')
					]),
				_List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				...
				_List_fromArray(
					[
						A2(contactItem, '/assets/phone.svg', '+36 70 882 0477'),
...
var $author$project$Main$EnteriorsImageClicked = function (a) {
	return {$: 'EnteriorsImageClicked', a: a};
};
...
var $author$project$Main$standardPadding = 20;
var $author$project$Main$enteriorImages = function () {
	var wrap = F2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Events$onClick(
							$author$project$Main$EnteriorsImageClicked(index)),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$padding4,
									$rtfeldman$elm_css$Css$zero,
									$rtfeldman$elm_css$Css$px($author$project$Main$standardPadding),
									$rtfeldman$elm_css$Css$px($author$project$Main$standardPadding),
									$rtfeldman$elm_css$Css$zero),
									$rtfeldman$elm_css$Css$width(
									$rtfeldman$elm_css$Css$pct(100)),
	...
	return A2(
		...
		wrap,
		$elm$core$Array$fromList($author$project$Images$enteriorok));
}();
...
var $author$project$Main$imagesForColumn = function (column) {
	return $elm$core$Array$toList(
		A2(
			...
			A2(
				...
				function (item) {
					return _Utils_eq(item.a, column);
				},
				$author$project$Main$enteriorImages)));
};
var $author$project$Main$enteriors = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Main$imagesForColumn(1)),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			$author$project$Main$imagesForColumn(2)),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			$author$project$Main$imagesForColumn(3))
		]));
var $author$project$Main$logoHeight = 60;
...
var $author$project$Main$height = A3(
	$rtfeldman$elm_css$Css$calc,
	$rtfeldman$elm_css$Css$vh(100),
	$rtfeldman$elm_css$Css$minus,
	$rtfeldman$elm_css$Css$px(($author$project$Main$logoHeight + (4 * $author$project$Main$standardPadding)) + 16));
var $rtfeldman$elm_css$Html$Styled$Attributes$id = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('id');
var $author$project$Main$home = function () {
	var wrap = function (src_) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$img,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$width($author$project$Main$standardWidth),
					$rtfeldman$elm_css$Html$Styled$Attributes$src(src_)
				]),
			_List_Nil);
	};
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$id('cf')
			]),
		_List_fromArray(
			[
...
var $author$project$Images$latvanytervek = _List_fromArray(
	['/assets/latvanytervek/01 eloszoba.jpg', '/assets/latvanytervek/01 konyha.jpg', '/assets/latvanytervek/02 konyha.jpg', '/assets/latvanytervek/02 nappali.jpg', '/assets/latvanytervek/03 konyha.jpg', '/assets/latvanytervek/03 nappali.jpg', '/assets/latvanytervek/04 nappali.jpg', '/assets/latvanytervek/05 nagyhalojpg.jpg', '/assets/latvanytervek/05 nappali.jpg', '/assets/latvanytervek/06 nagyhalo.jpg', '/assets/latvanytervek/06 nappali.jpg', '/assets/latvanytervek/07 nagyhalo.jpg', '/assets/latvanytervek/08 kishalo.jpg', '/assets/latvanytervek/09 kishalo.jpg']);
var $author$project$Main$MoodboardsImageClicked = function (a) {
	return {$: 'MoodboardsImageClicked', a: a};
};
var $author$project$Main$moodboards = function () {
	var width = (($author$project$Main$standardWidth - $author$project$Main$standardPadding) / 2) + 10;
	var wrap = F2(
		function (index, image) {
			return A2(
				$rtfeldman$elm_css$Html$Styled$img,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$src(image),
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						$author$project$Main$MoodboardsImageClicked(index)),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$boxSizing($rtfeldman$elm_css$Css$borderBox),
	...
	return A2(
		...
		$elm$core$Array$toList(
			A2(
				$elm$core$Array$indexedMap,
				wrap,
				$elm$core$Array$fromList($author$project$Images$latvanytervek))));
}();
var $author$project$Main$content_ = function (route) {
	switch (route.$) {
		case 'Home':
		...
		case 'Enteriors':
			if (route.a.$ === 'Nothing') {
				...
				var index = route.a.a;
				return A4(
					$author$project$ImageViewer$call,
					$elm$core$Array$fromList($author$project$Images$enteriorok),
					$author$project$Main$height,
					$author$project$Main$ImageRequested($author$project$Main$Enterior),
					index);
			}
		case 'Moodboards':
			if (route.a.$ === 'Nothing') {
				...
				return A4(
					...
					$elm$core$Array$fromList($author$project$Images$latvanytervek),
					$author$project$Main$height,
					$author$project$Main$ImageRequested($author$project$Main$Moodboard),
					index);
			}
		case 'About':
...
var $author$project$Main$content = function (route) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Main$content_(route)
			]));
};
...
var $author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('© 2021 Fekete Roberta')
				]))
		]));
...
var $author$project$Main$theme = {
	...
	secondary: A3($rtfeldman$elm_css$Css$rgb, 255, 255, 255)
};
var $rtfeldman$elm_css$Css$top = $rtfeldman$elm_css$Css$prop1('top');
var $author$project$Main$header = function () {
	var passiveHeaderItem = F2(
		function (msg, label) {
			return A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$height(
						$rtfeldman$elm_css$Css$px($author$project$Main$logoHeight)),
	...
	return A2(
		...
		_List_fromArray(
			[
				logo,
				A2(passiveHeaderItem, $author$project$Main$HomeClicked, '| FEKETE ROBERTA lakberendező'),
...
var $author$project$Main$viewPage = function (route) {
	var footer_ = _Utils_eq(route, $author$project$Main$Home) ? _List_Nil : _List_fromArray(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$author$project$Main$content(route),
						footer_)))
			]));
};
var $author$project$Main$body = function (route) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Main$viewPage(route)
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				$author$project$Main$body(route))
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Index":{"args":[],"type":"Basics.Int"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"HomeClicked":[],"EnteriorsClicked":[],"MoodboardsClicked":[],"AboutClicked":[],"ContactClicked":[],"EnteriorsImageClicked":["Main.Index"],"MoodboardsImageClicked":["Main.Index"],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"ImageRequested":["Main.Album","Main.Index"]}},"Main.Album":{"args":[],"tags":{"Enterior":[],"Moodboard":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));